...
const REGIONS = {
 wales: [
    ...
    "barry","barry dock","porthcawl","glamorgan","burry port"
  ],
  scotland: [
  ...
  england: [
    ...
    'suffolk','hants','southend-on-sea','mudeford', 'wicklow'   
  ],
  ireland: [
    'dublin','galway','cork','belfast','londonderry','waterford',
    'dún laoghaire','dun laoghaire','donegal','lough derg','enniskillen','down'
  ]
};
